...
static int vita3d_initialized = 0;
...
float _vita3d_ortho_matrix[4*4];
float _vita3d_perspective_matrix[4*4];
SceGxmContext *_vita3d_context = NULL;
SceGxmVertexProgram *_vita3d_colorVertexProgram = NULL;
SceGxmFragmentProgram *_vita3d_colorFragmentProgram = NULL;
SceGxmVertexProgram *_vita3d_textureVertexProgram = NULL;
SceGxmFragmentProgram *_vita3d_textureFragmentProgram = NULL;
SceGxmFragmentProgram *_vita3d_textureTintFragmentProgram = NULL;
const SceGxmProgramParameter *_vita3d_clearClearColorParam = NULL;
const SceGxmProgramParameter *_vita3d_colorWvpParam = NULL;
const SceGxmProgramParameter *_vita3d_textureWvpParam = NULL;
const SceGxmProgramParameter *_vita3d_textureTintColorParam = NULL;
...
int vita3d_init()
{
	return vita3d_init_advanced(DEFAULT_TEMP_POOL_SIZE);
}
...
int vita3d_init_advanced(unsigned int temp_pool_size)
{
	...
	if (vita3d_initialized) {
		DEBUG("libvita3d is already initialized!\n");
		return 1;
	}
	...
	err = sceGxmCreateContext(&contextParams, &_vita3d_context);
	...
	err = sceGxmShaderPatcherCreateFragmentProgram(
		...
		&_vita3d_textureFragmentProgram);
	...
	err = sceGxmShaderPatcherCreateFragmentProgram(
		...
		&blend_info,
		textureVertexProgramGxp,
		&_vita3d_textureTintFragmentProgram);
	...
	_vita3d_colorWvpParam = sceGxmProgramFindParameterByName(colorVertexProgramGxp, "wvp");
	DEBUG("color wvp sceGxmProgramFindParameterByName(): %p\n", _vita2d_colorWvpParam);

	_vita3d_textureWvpParam = sceGxmProgramFindParameterByName(textureVertexProgramGxp, "wvp");
	DEBUG("texture wvp sceGxmProgramFindParameterByName(): %p\n", _vita2d_textureWvpParam);

	_vita3d_textureTintColorParam = sceGxmProgramFindParameterByName(textureTintFragmentProgramGxp, "uTintColor");
	DEBUG("texture wvp sceGxmProgramFindParameterByName(): %p\n", _vita2d_textureWvpParam);
	...
	matrix_init_orthographic(_vita3d_ortho_matrix, 0.0f, DISPLAY_WIDTH, DISPLAY_HEIGHT, 0.0f, 0.0f, 1.0f);
...
int vita3d_fini()
{
	...
	sceGxmShaderPatcherReleaseFragmentProgram(shaderPatcher, _vita3d_colorFragmentProgram);
	sceGxmShaderPatcherReleaseVertexProgram(shaderPatcher, _vita3d_colorVertexProgram);
	sceGxmShaderPatcherReleaseFragmentProgram(shaderPatcher, _vita3d_textureFragmentProgram);
	sceGxmShaderPatcherReleaseFragmentProgram(shaderPatcher, _vita3d_textureTintFragmentProgram);
	sceGxmShaderPatcherReleaseVertexProgram(shaderPatcher, _vita3d_textureVertexProgram);
...
{
	// set clear shaders
	sceGxmSetVertexProgram(_vita3d_context, clearVertexProgram);
	sceGxmSetFragmentProgram(_vita3d_context, clearFragmentProgram);

	// set the clear color
	void *color_buffer;
	sceGxmReserveFragmentDefaultUniformBuffer(_vita3d_context, &color_buffer);
	sceGxmSetUniformDataF(color_buffer, _vita3d_clearClearColorParam, 0, 4, clear_color);

	// draw the clear triangle
	sceGxmSetVertexStream(_vita3d_context, 0, clearVertices);
	sceGxmDraw(_vita3d_context, SCE_GXM_PRIMITIVE_TRIANGLES, SCE_GXM_INDEX_FORMAT_U16, clearIndices, 3);
}
...
{
	sceGxmEndScene(_vita3d_context, NULL, NULL);
}
